...
::Security Kits for Validation
dotnet pack src/Cosmos.Validation.Extensions.Verification/Cosmos.Validation.Extensions.Verification.csproj -c Release -o nuget_packages --no-restore
